<template>
    <v-layout align-start>
        ...
        <v-dialog v-model="adModal" max-width="290px">
            <v-card>
                <v-card-tittle class="headline" v-if="adAccion==1">Activar Item?</v-card-tittle>
                <v-card-tittle class="headline" v-if="adAccion==2">Desactivar Item?</v-card-tittle>
                <v-card-text>
                    Estas a punto de 
...
export default 
{
    ...
    methods:
    {
        ...
        editItem (item) 
        {
            ...
            this.passwordAnt= item.passwordAnt;
            this.editedIndex=1;
            this.dialog = true
        },
        ...
        validar()
        {
            ...
            if (!this.email )
            {
             ...
             if (!this.password )
            {
                this.validaMensaje.push("Ingrese la password.");
            }
